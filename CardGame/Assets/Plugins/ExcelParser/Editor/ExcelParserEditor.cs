...
namespace ExcelParser
{
    ...
    public class ExcelParserEditor : Editor
    {
        ...
        public static string FileDir_DataTxt = "../DataTXT";
...
//                    outfile.WriteLine(" ");
        ...
        static void GenerateDataMgrCs(string fileName)
        {
            ...
            stIndex += 7;
            if (ctStr.IndexOf(fileName + "SetMgr.instance.loadDataFile(prePath);", StringComparison.Ordinal) < 0)
            {
                string insetStr = "\r        " + fileName + "SetMgr.instance.loadDataFile(prePath);\r";
        ...
        static void Export_oneExcel_Txt(bool autoGenerateClass, string path, string fileName)
        {
            if (path.EndsWith(".xlsx"))
            {
                ...
                targetFile = targetFile.Insert(lastI + 1, "../DataTXT/");
